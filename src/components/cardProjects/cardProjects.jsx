...
const cardProjects = (props) => {
  return (
    <div className='flex max-sm:flex-col max-sm:gap-8 max-sm:px-3 max-sm:py-3 max-sm:pb-16 flex justify-center items-center rounded-lg shadow-sm  px-6 py-6 border mb-4 bg-white'>
