...
<          div className='flex gap-12 justify-center items-center max-sm:flex-col'>
            <div className='flex gap-3 items-center'>
              <a className='flex gap-2 justify-center items-center px-2 py-2 rounded-full shadow-lg'href="https://www.linkedin.com/in/paulo-matheus-a227001b8/" target='blank'><img className="w-6 h-6" src={LinkedIn} alt="" />
              </a>
              ...
              <p className='font-poppins text-xl text-gray-600 max-sm:text-lg'>paulo22tr22@gmail.com</p>
              </div>
          </div>
        </div>
      </div>
